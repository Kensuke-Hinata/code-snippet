...
public interface CymbolListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link CymbolParser#variableDeclare}.
	 * @param ctx the parse tree
	 */
	void enterVariableDeclare(CymbolParser.VariableDeclareContext ctx);
	/**
	 * Exit a parse tree produced by {@link CymbolParser#variableDeclare}.
	 * @param ctx the parse tree
	 */
	void exitVariableDeclare(CymbolParser.VariableDeclareContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link CymbolParser#functionDeclare}.
	 * @param ctx the parse tree
	 */
	void enterFunctionDeclare(CymbolParser.FunctionDeclareContext ctx);
	/**
	 * Exit a parse tree produced by {@link CymbolParser#functionDeclare}.
	 * @param ctx the parse tree
	 */
	void exitFunctionDeclare(CymbolParser.FunctionDeclareContext ctx);
	/**
